...
sf::Color Utils::Lerp(const sf::Color& min, const sf::Color& max, float t, bool clamp)
{
    ...
    sf::Uint8 r = min.r + (sf::Uint8)((max.r - min.r) * t);
    sf::Uint8 g = min.g + (sf::Uint8)((max.g - min.g) * t);
    sf::Uint8 b = min.b + (sf::Uint8)((max.b - min.b) * t);
    sf::Uint8 a = min.a + (sf::Uint8)((max.a - min.a) * t);
